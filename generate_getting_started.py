    ...
    s += [
        ...
        field_table([
            ...
            ("Sourced / Pre-made Block", "Check this if the block came from a supplier (e.g. North Spore) "
                                          ...
                                          "<b>Colonized</b> and update to <b>Fruiting</b> once it enters "
                                          "the chamber. Status is the source of truth — the agent "
                                          "uses colonized guardrails during cold shock and fruiting "
                                          "guardrails once the block is in the chamber. "
