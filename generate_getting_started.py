    ...
    s += [
        ...
        *action([
        ...
        callout(
            ...
            "Each entry shows growing conditions (temperature range, humidity range, CO2 range, "
            "and substrate notes), a catalog description where available, and a space for your "
            "own personal grow notes. "
