    ...
    s += [
        ...
        *action([
        ...
        callout(
            ...
            "A Colonized batch with no Fruiting Chamber Date is treated as an intentional hold "
            "(cold shock or pre-chamber staging) — the agent will not prompt you to set that date "
            "or flag it as a gap. Set the Fruiting Chamber Date the day the block enters the SGFC "
            "and the agent will switch to fruiting guardrails automatically. "
        ...
        callout(
            ...
            "Each entry shows growing conditions (fruiting and colonization temperature ranges, "
            "humidity range, CO2 range, and substrate notes), a catalog description where "
            "available, and a space for your own personal grow notes. "
